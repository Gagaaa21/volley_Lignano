...
const controlClass =
  "w-full rounded-xl border border-border-subtle bg-surface px-3.5 py-2.5 text-sm text-foreground placeholder:text-foreground/35 focus:border-primary/60 focus:outline-none focus:ring-4 focus:ring-primary/12 transition-all duration-150 disabled:opacity-50";
